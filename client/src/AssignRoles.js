            ...
            <div className='container mt-5 pt-5'>
                ...
                <div className="">
                    <div className="cs-cta cs-style2 text-center cs-white_bg py-3 m-0">
                        <h2 className="cs-cta_title">Current Account Address</h2>
                ...
                <div className='mt-5 mb-5'>
                    ...
                    <form onSubmit={handlerSubmitRMS} class="row ">
                        <div class="col-md-6 mb-3">
                            <input class="form-control cs-search_input" type="text" onChange={handlerChangeAddressRMS} placeholder="Ethereum Address" required />
                        </div>
                        <div class="col-md-6 mb-3">
                            <input class="form-control" type="text" onChange={handlerChangeNameRMS} placeholder="Raw Material Supplier Name" required />
                        </div>
                        <div class="col-12 mb-3">
                            <textarea class="form-control" type="text" onChange={handlerChangePlaceRMS} placeholder="Based In" required />
                        </div>
                        <div class="col-12 mb-3">
                            <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitRMS}>Register</button>
                        </div>
                    </form>
                ...
                <div className='mt-5 mb-5'>
                    <h4>Manufacturers</h4>
                    <form onSubmit={handlerSubmitMAN} class="row">
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeAddressMAN} placeholder="Ethereum Address" required />
                        </div>
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeNameMAN} placeholder="Manufacturer Name" required />
                        </div>
                        <div class="col-12 mt-3">
                            <textarea class="form-control" type="text" onChange={handlerChangePlaceMAN} placeholder="Based In" required />
                        </div>
                        <div class="col-12 mt-3">
                            <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitMAN}>Register</button>
                        </div>
                    </form>
                ...
                <div className='mt-5 mb-5'>
                    <h4>Distributors</h4>
                    <form onSubmit={handlerSubmitDIS} class="row">
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeAddressDIS} placeholder="Ethereum Address" required />
                        </div>
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeNameDIS} placeholder="Distributor Name" required />
                        </div>
                        <div class="col-12 mt-3">
                            <textarea class="form-control" type="text" onChange={handlerChangePlaceDIS} placeholder="Based In" required />
                        </div>
                        <div class="col-12 mt-3">
                            <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitDIS}>Register</button>
                        </div>
                    </form>
                ...
                <div className='mt-5 mb-5'>
                    <h4>Retailers</h4>
                    <form onSubmit={handlerSubmitRET} class="row">
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeAddressRET} placeholder="Ethereum Address" required />
                        </div>
                        <div class="col-md-6">
                            <input class="form-control" type="text" onChange={handlerChangeNameRET} placeholder="Retailer Name" required />
                        </div>
                        <div class="col-12 mt-3">
                            <textarea class="form-control" type="text" onChange={handlerChangePlaceRET} placeholder="Based In" required />
                        </div>
                        <div class="col-12 mt-3">
                            <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitRET}>Register</button>
                        </div>
                    </form>
