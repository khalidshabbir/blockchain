        ...
        <>
            ...
            <div className='container mt-5 pt-5 mb-5'>
                ...
                <div className='mb-5'>
                    ...
                    <div className='text-center mt-5'><h3><b>Retailers</b></h3></div>
                    <p>Medicine Order -&gt; Raw Material Supplier -&gt; Manufacturer -&gt; Distributor -&gt;<b className='text-primary'> Retailer -&gt; Consumer</b></p>
                    ...
                    <div className='mt-5'>
                        ...
                        <h5>Only a registered Retailer can perform this step</h5>
                        <form onSubmit={handlerSubmitRetail} class="row">
                            <div class="col-12">
                                <input class="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                            </div>
                            <div class="col-12 mt-3">
                                <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitRetail}>Retail</button>
                            </div>
                        </form>
                        ...
                        <br />
                        <h5>Only a registered Retailer can perform this step</h5>
                        <form onSubmit={handlerSubmitSold} class="row">
                            <div class="col-12">
                                <input class="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                            </div>
                            <div class="col-12 mt-3">
                                <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitSold}>Sold</button>
                            </div>
                        </form>
