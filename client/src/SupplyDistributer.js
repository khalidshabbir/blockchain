        ...
        <>
            ...
            <div className='container mt-5 pt-5 mb-5'>
                ...
                <div className='mb-5'>
                    ...
                    <div className='text-center mt-5'><h3><b>Distributor</b></h3></div>
                    <p>Medicine Order -&gt; Raw Material Supplier -&gt; Manufacturer -&gt;<b className='text-primary'> Distributor </b> -&gt; Retailer -&gt; Consumer</p>
             ...
             <div>
             <h5>Only a registered Distributor can perform this step</h5>
                <form onSubmit={handlerSubmitDistribute} class="row">
                    <div class="col-12">
                        <input class="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                    </div>
                    <div class="col-12 mt-3">
                        <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitDistribute}>Distribute</button>
                    </div>
                </form>
...
export default SupplyDistributer
