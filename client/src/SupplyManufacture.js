        ...
        <>
            ...
            <div className='container mt-5 pt-5 mb-5'>
                ...
                <div className='mb-5'>
                    ...
                    <p>Medicine Order -&gt; Raw Material Supplier -&gt; <b className='text-primary'> Manufacturer </b> -&gt; Distributor -&gt; Retailer -&gt; Consumer</p>
                ...
                <div>
                    <h5><b>Only a registered Manufacturer can perform this step</b></h5>
                    <form onSubmit={handlerSubmitManufacturing} class="row">
                        <div class="col-12">
                            <input class="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                        </div>
                        <div class="col-12 mt-3">
                            <button class="btn btn-outline-success btn-block w-100" onSubmit={handlerSubmitManufacturing}>Manufacture</button>
                        </div>
                    </form>
...
export default SupplyManufacture
