                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="cs-form_field_wrap">
                                                <input type="text" className="cs-form_field" placeholder="Full Name" />
                                            </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="cs-form_field_wrap">
                                                <input type="text" className="cs-form_field" placeholder="Wright Subject" />
                                            </div>
                                            <div className="cs-height_20 cs-height_lg_20" />
                                        </div>
                                        <div className="col-lg-12">
                                            <div className="cs-form_field_wrap">
                                                <textarea cols={30} rows={5} placeholder="Message..." className="cs-form_field" defaultValue={""} />
                                            </div>
                                            <div className="cs-height_20 cs-height_lg_20" />
                                        </div>
                                        <div className="col-lg-12">
